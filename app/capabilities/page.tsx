...
const capabilities = [
  "Reference architecture review for RAG, agents, LLMOps, and evidence-oriented workflows",
  ...
  return (
    <>
      <Section
        ...
        description="LorvexAI publishes educational architecture patterns for controlled AI systems in regulated environments. These materials support governance discussion and prototype scoping; they are not compliance certification, professional advice, or production implementation claims."
      >
      ...
      <Section title="Discuss educational capability support" description="">
        <CTA />
      </Section>
    </>
  );
