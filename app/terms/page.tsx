...
const sections = [
  ...
  ["Prototype and product-lab limitations", "Product-lab concepts, dashboards, screenshots, diagrams, and prototypes are educational reference designs. They are not production systems, regulated decision systems, compliance engines, clinical systems, medical devices, or certified control frameworks."],
  ...
  return (
    <section className="section">
      <div className="mx-auto w-full max-w-4xl px-6">
        ...
        <h1 className="mt-3 text-4xl font-semibold text-white md:text-5xl">Terms of Use</h1>
